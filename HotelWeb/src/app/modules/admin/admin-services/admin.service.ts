...
export class AdminService {
  ...
  // ✅ Corrected method for changing reservation status
...
approveReservation(reservationId:number): Observable<any> {
  return this.http.put(`${BASIC_URL}api/admin/reservation/approve/${reservationId}`, null, { headers: this.createAuthorizationHeader() });
}
